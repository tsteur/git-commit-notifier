...
As you see, key and value were enclosed into single quotes. \b means that "follow" must not be preceded by other word chars, so "befollow" will not match but "be follow" will match. After "follow" we expect onw or more spaces followed by group of one or more digits. Resulting url contains \1 that will be replaced with matched group of digits.
