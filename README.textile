...
Each key of message_map is a case sensitive Regexp pattern, and its value is the replacement string. Backreferences to match groups of given Regexp supported through \1-\9 expressions.

See also <a href="http://ruby-doc.org/core/classes/String.html#M000817">Ruby String#gsub documentation</a> and example of the config file.
