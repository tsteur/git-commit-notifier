...
See <a href="http://github.com/bodo/git-commit-notifier/blob/master/config/git-notifier-config.yml.sample">config/git-notifier-config.yml.sample</a> for overriding these settings.
